    ...
    try {
      const result = await fetch("/api/rsvp", {
        ...
        body: JSON.stringify({
          ...
          email,
          attendance,
          guestsBringing: Number(guestsBringing),
          message,
        }),
      });
    ...
    >
      ...
      <div className="relative mx-auto max-w-[760px]">
        <div className="mb-2 text-center sm:mb-14">
          ...
          <h2
            id="rsvp-title"
            className="mt-2 font-serif text-[clamp(2.0rem,8vw,5.5rem)] italic leading-none tracking-[0.05em]"
          >
            Join Me
          </h2>

          <p className="mx-auto mt-2 max-w-[660px] font-serif text-base italic leading-8 text-[#d0c6b9] sm:text-lg">
            I would love to celebrate this beautiful milestone
            with you. Kindly confirm your attendance and let me
            know if you will be bringing someone along.
          </p>
        </div>
            ...
            {isAttending && (
              <label className="flex flex-col gap-2 sm:col-span-2">
                ...
                >
                  ...
                  <option value="4">4 additional people</option>
                  <option value="5">5 additional people</option>
                </select>
                ...
                {isBringingGuests && (
                  <p className="text-xs leading-6 text-[#d0c6b9]">
                    ...
                    . A table will be allocated automatically
                    after submission.
                  </p>
                )}
              </label>
